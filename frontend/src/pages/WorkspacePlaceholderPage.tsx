...
> = {
  ...
  chats: {
    title: 'Личные чаты',
    lead: 'Список бесед и быстрый старт группового чата.',
    body: [
      'Рыба-текст: обсудили с коллегами сроки релиза, договорились перенести встречу на вторник. Групповой чат «Проект Альфа» пока содержит только приглашение-заглушку.',
      'Кнопка «Создать групповой чат» откроет мастер, когда backend будет готов.',
    ],
  },
  feed: {
    title: 'Лента событий',
